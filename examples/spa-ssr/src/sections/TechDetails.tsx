...
/**
 * A code-split section, loaded via lazy() inside a <Suspense> boundary on the
...
export default component(() => {
    return () => (
        <div class="card">
            <h3 style="margin-top: 0;">Lazy-loaded section (Suspense)</h3>
            <p>This block lives in a separate chunk — <code>lazy(() =&gt; import('./sections/TechDetails'))</code> wrapped in <code>&lt;Suspense&gt;</code>.</p>
            <ul>
