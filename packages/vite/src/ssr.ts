...
// ============================================================================
// collectAssets — moved to `@sigx/vite/assets` (#486)
// ============================================================================

// The resolver is pure; this module is not (the dev handler below imports
// `node:fs/promises` and `node:path`). Keeping them together made
// `collectAssets` unreachable from a workerd/edge entry. Re-exported so every
// existing `@sigx/vite/ssr` import keeps working.
export {
    collectAssets,
    type ViteManifest,
