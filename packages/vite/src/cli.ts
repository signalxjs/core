...
function generateDts(components: ComponentInfo[], rootDir: string): string {
 ...
 */
function generateComponentsTs(components: ComponentInfo[], rootDir: string): string {
    if (components.length === 0) {
        return `// Auto-generated by @sigx/vite - no components found
export {};
`;
...
function shouldProcess(filePath: string, options: ScanOptions): boolean {
...
function scanDirectory(dir: string, options: ScanOptions, components: ComponentInfo[]): void {
